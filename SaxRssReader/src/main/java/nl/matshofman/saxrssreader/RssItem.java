...
public class RssItem implements Comparable<RssItem>, Parcelable {
    ...
    /** pnaleks: utl attribute of enclosure element */
    ...
    /**
     * pnaleks:
     * Sets {@link #imageUrl} field for enclosure of "image/*" type
     *
     * @param attributes Attributes passed to {@link RssHandler#startElement(String, String, String, Attributes)}
     */
    public void setEnclosureAttributes(Attributes attributes) {
