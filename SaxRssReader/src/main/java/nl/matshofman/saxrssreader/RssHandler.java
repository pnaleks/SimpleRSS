...
public class RssHandler extends DefaultHandler {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) {
		...
		// pnaleks: Processing attributes for "enclosure" element
		if(qName.equals("enclosure") && rssItem != null) {
			rssItem.setEnclosureAttributes(attributes);
		}
	}
	...
	public void endElement(String uri, String localName, String qName) {
		if(rssFeed != null && rssItem == null) {
			...
			try {
				if(qName.equals("content:encoded")) qName = "content";
				String methodName = "set" + qName.substring(0, 1).toUpperCase() + qName.substring(1);
